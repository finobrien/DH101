...
## Process Notes
I made this on my own with some assistance from AI, using Voyant and ChatGTP. I decided everything about the project by choosing which speech to analyze and which sites to use for the analysis.
